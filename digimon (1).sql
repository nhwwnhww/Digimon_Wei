...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 22, 2023 at 06:33 AM
...
CREATE TABLE `competion` (
  ...
  `Winner_own_id` int(50) NOT NULL,
  `Loser_own_id` int(50) NOT NULL,
...
(2, '123', '123', '2023-03-01', '123', '123', 123, 'stone', 'no'),
(3, '123', '123', '2023-03-02', '333', '123', 123, 'stone', 'no');
...
INSERT INTO `tamers_owns` (`Owner_id`, `User_id`, `Digimon_id`, `Data`, `Level`) VALUES
(1, 2, 9, '2023/03/22', 1),
(2, 2, 249, '2023/03/22', 1),
(3, 2, 93, '2023/03/22', 1),
(4, 3, 200, '2023/03/22', 1),
(5, 3, 20, '2023/03/22', 1),
(6, 3, 218, '2023/03/22', 1);
...
ALTER TABLE `competion`
  ...
  ADD KEY `Winner_own_id` (`Winner_own_id`),
  ADD KEY `Loser_own_id` (`Loser_own_id`),
...
--
-- AUTO_INCREMENT for table `tamers_owns`
--
ALTER TABLE `tamers_owns`
  MODIFY `Owner_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `competion`
  ADD CONSTRAINT `competion_ibfk_1` FOREIGN KEY (`Winner_own_id`) REFERENCES `tamers_owns` (`Owner_id`),
  ADD CONSTRAINT `competion_ibfk_2` FOREIGN KEY (`Loser_own_id`) REFERENCES `tamers_owns` (`Owner_id`),
  ADD CONSTRAINT `competion_ibfk_3` FOREIGN KEY (`Organizer_id`) REFERENCES `tamers` (`User_id`);
