                ...
                <div id="content">
                    ...
                    <div class="article">
                        <div class="box-sizing">
                            ...
                            <a id="jump" href="tamer_info.php" type="button" class="btn btn-primary text-white" style="text-decoration:none">return to previous page</a>
                            <?php
                                if (isset($_GET["web"])){
                                    $web = $_GET["web"];
                                    if (isset($_GET["p_web"])){
                                        $p_web = $_GET["p_web"];
                                        echo "<script>document.getElementById('jump').href = '$web.php?web=$p_web';</script>";
                                    }
                                    else{
                                    // echo $web;
