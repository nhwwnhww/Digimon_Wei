    ...
    <div id="nav-site">
        <div class="max-width">
            ...
            <ul>
                ...
                <li><a href="#">Sort</a>
                        <ul>
                            <li><a href="select_digimon.php?sort=HP<?php if(isset($_GET["web"])){
                                    $web = $_GET["web"];
                                    echo "&web=$web";
                                }?>">Sort by HP</a></li>
                            <li><a href="select_digimon.php?sort=Attack<?php if(isset($_GET["web"])){
                                    $web = $_GET["web"];
                                    echo "&web=$web";
                                }?>">Sort by Attack</a></li>
                            <li><a href="select_digimon.php?sort=Level<?php if(isset($_GET["web"])){
                                    $web = $_GET["web"];
                                    echo "&web=$web";
                                }?>">Sort by Digimon level</a></li>
                        </ul>
                </li>
            </ul>
        </div>
                    ...
                    <ol>
                        ...
                        <li>
                            <?php
                                if(isset($_GET["web"])){
                                    $web = $_GET["web"];
                                    echo "<a href='$web.php'>Tamer's Home Page</a>";
                                }
                                else{
                                    echo "<a href='Find_match.php'>Find match Page</a>";
                                }
                            ?>
                        </li>
                        <li class="last-child">Tamer's Digimon</li>
                    </ol>
                </div>
                <div id="content">
                    ...
                    <div class="article">
                        <div class="box-sizing">
                            ...
                            <a href='get_random_digimon.php?web=select_digimon<?php if(isset($_GET["web"])){
                                    $web = $_GET["web"];
                                    echo "&p_web=$web";
                                }?>' type="button" class="btn btn-primary text-white" style="text-decoration:none">get more digimon</a>
                            ...
                            ?>' type="button" class="btn btn-secondary text-white" style="text-decoration:none">back</a>
