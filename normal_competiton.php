...
<body>
    ...
    <div id="nav-site">
        <div class="max-width">
            ...
            <ul>
                ...
                <li><a href="Find_match.php">Select Digimon</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div id="content-container">
                <div id="breadcrumbs">
                    ...
                    <ol>
                        ...
                        <li class="last-child">Find your opponent</li>
                    </ol>
                </div>
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo                 "<h5 class='card-title'>Opponent Tame:$Tamer</h5>
        <p class='card-text'>Digimon name: $Name</p>
        <p class='card-text'>Type: $Type</p>
        <p class='card-text'>Level: $Level</p>
        <p class='card-text'>HP: $HP (+$add_HP)</p>
        <p class='card-text'>Attack: $Attack (+$add_Attack)</p>";
        echo '<input type="submit" class="btn btn-primary" value="Fight!!">';
    ...
    ?>
    <hr>
    <a href="Find_match.php" class="btn btn-secondary text-white" style="text-decoration:none">cancel this competion</a>
                            </div>
                            </div>
                        </div>
                    </div>
